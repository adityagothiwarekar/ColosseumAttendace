...
const PiyushTalk = () => {
  ...
  const aliTalkWorkshopName = "Piyush Talk";
  ...
  const handleFileUpload = (event) => {
    ...
    Papa.parse(file, {
      ...
      complete: (result) => {
        ...
        let lastProcessedRow = localStorage.getItem("lastProcessedRowPiyush");
  ...
  const sendBulkEmails = async () => {
    ...
    if (maxRowNumber > 0) {
      ...
      localStorage.setItem("lastProcessedRowPiyush", maxRowNumber);
    }
